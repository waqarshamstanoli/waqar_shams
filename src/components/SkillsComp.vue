<template>
  <v-container class="md-px-16 md-pt-16">
    <v-row class="justify-center" :class="{ square: test }" ref="sectionElement">
      ...
      <v-col cols="12" lg="2" md="4" sm="6" class="paragraphLeft " :class="{ 'paragraphLeft  cusotmCol': !$vuetify.breakpoint.mdAndUp, 'paragraphLeft': $vuetify.breakpoint.mdAndUp }" v-for="skill in skills" :key="skill">
